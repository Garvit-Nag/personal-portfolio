          ...
          <ScrollAnimation delay={1} className="block">
            <div className="flex flex-col">
              {SNAPSHOTS.map((item) => (
                ...
                >
                  <ChevronRight size={14} strokeWidth={2} className="text-[#5a5a5a] shrink-0 group-hover:text-[#9a9a9a] transition-colors duration-200" />
                  <span className="font-mono text-[10px] tracking-[0.15em] text-[#6a6a6a] uppercase w-24 shrink-0 group-hover:text-[#8a8a8a] transition-colors duration-200">
                    {item.label}
                  </span>
